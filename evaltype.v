...
Proof.
  ...
  intros x.
  induction x; intros;
  inversion H; inversion H0; subst; clear H H0; try easy.
  all: repeat multimatch goal with
       | [H1:  ?x --> ?a, H2: ?x --> ?b |- _] => learn (IHx a b H1 H2); subst
       | H: _ _ = _ _ |- _ => (try injection H; intros; subst)
       | H: ?a = ?a |- _ => clear H
       | H: nvalue zro |- _ => clear H
       | H: lvalue nil |- _ => clear H
       | _ => try easy
  end.
  destruct y1; try easy.
